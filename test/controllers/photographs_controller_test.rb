...
class PhotographsControllerTest < ActionController::TestCase
  ...
  test "should create photograph" do
    assert_difference('Photograph.count') do
      post :create, photograph: { photographer: @photograph.photographer, photoid: @photograph.photoid, photourl: @photograph.photourl }
    end
  ...
  test "should update photograph" do
    patch :update, id: @photograph, photograph: { photographer: @photograph.photographer, photoid: @photograph.photoid, photourl: @photograph.photourl }
    assert_redirected_to photograph_path(assigns(:photograph))
  end
